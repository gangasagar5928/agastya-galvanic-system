...
5. **Gravimetric Energy Density Trade-Off:** The primary earthenware stack delivers a modest specific energy density ($\sim 12\text{--}18\text{ Wh/kg}$) compared to commercial lithium cells ($>200\text{ Wh/kg}$). Its optimal application domain is strictly stationary, low-embodied-energy, disposable environmental telemetry, soil monitoring, and green hydrogen educational demonstrations.
